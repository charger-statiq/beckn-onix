...
# Optional env:  REDIS_ADDR (default redis-onix-bpp:6379)  HUB_OCPI_BECKN_URL (default http://hub-ocpi.statiq-dev:5000/beckn)
...
echo "rendered -> $OUT  (redis=$REDIS_ADDR, hub=$HUB_OCPI_BECKN_URL, cds=$CDS_PUBLISH_BASE_URL)"
